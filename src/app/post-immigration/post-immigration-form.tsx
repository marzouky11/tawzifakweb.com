...
const formSchema = z.object({
  ...
  programType: z.enum(['work', 'study', 'seasonal', 'training', 'volunteer', 'crafts', 'health', 'tech', 'transport', 'hospitality', 'education', 'agriculture', 'finance'], { required_error: "نوع البرنامج مطلوب." }),
