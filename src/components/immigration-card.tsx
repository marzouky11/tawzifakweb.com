...
export function ImmigrationCard({ post }: ImmigrationCardProps) {
  ...
  return (
    <Card className="flex flex-col h-full overflow-hidden rounded-xl shadow-md border-4 border-double bg-card hover:shadow-2xl transition-all duration-300" style={{ borderColor: sectionColor }}>
